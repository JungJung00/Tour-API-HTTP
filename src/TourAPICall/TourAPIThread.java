...
public class TourAPIThread extends Thread {
    ...
    public ArrayList<Festival> getNearFestivals() { return nearFestivals; }
    ...
    public void run(){
        ...
        searchParamMap.put("areaCode", "31");    // TODO 준환이 구현한 메서드로 대체
        searchParamMap.put("sigunguCode", "13");    // TODO 준환이 구현한 메서드로 대체
        ...
        do{
            /* Get near ongoing festivals' information(address, img, title, etc.) */
